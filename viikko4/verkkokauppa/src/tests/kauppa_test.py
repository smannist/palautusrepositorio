...
class TestKauppa(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.viite = self.viitegeneraattori_mock.uusi.return_value = 42
    ...
    def test_useamman_tuotteen_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
    ...
    def test_tuotteen_ostos_ei_ole_mahdollista_jos_saldoa_ei_ole_tarpeeksi(self):
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                return Tuote(1, "maito", 5)
            if tuote_id == 2:
                return Tuote(2, "bugatti chiron 2022", 3500000)
